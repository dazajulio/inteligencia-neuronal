...
(
    'bootcamp-n8n',
    'bootcamp-n8n',
    'PROGRAMA TECNICO // EN VIVO',
    'Intermedio a Avanzado',
    'Bootcamp: Arquitectura de Pipelines con n8n & Agentes IA',
    'Despliegue de infraestructura soberana sobre VPS dedicado, webhooks reversos y orquestacion de agentes con PostgreSQL.',
    'Aprende a desplegar infraestructura empresarial de automatizacion sobre servidores VPS dedicados, orquestando agentes autonomos, PostgreSQL y WhatsApp Cloud API.',
    '6 Semanas Intensivas',
    197.00,
    '$197 USD',
    'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80',
    'from-[#1DACE3] via-[#0284c7] to-[#4f46e5]',
    '["n8n Self-Hosted", "Docker & Caddy", "PostgreSQL", "Meta Cloud API", "LangChain / LLMs"]'::jsonb,
    'https://inteligencia-neuronal.lemonsqueezy.com/checkout/buy/f1296f2f-a896-4fe3-87eb-0f8046fe1407',
    'ACTIVO',
    14,
    2
...
VALUES 
    ...
    ('bootcamp-n8n', '01', 'Despliegue VPS con Docker, n8n & Caddy SSL', 'Arquitectura de infraestructura soberana, configuracion de variables de entorno y proxy inverso con HTTPS.', 1),
    ('bootcamp-n8n', '02', 'Meta Cloud API & Webhooks Reversos de WhatsApp', 'Ingenieria de conexion oficial con WhatsApp Cloud API, handshake y recepcion de eventos.', 2),
    ('bootcamp-n8n', '03', 'Bases de Datos Relacionales & Row-Level Security (PostgreSQL / Supabase)', 'Persistencia de leads, pedidos y catalogos en PostgreSQL con politicas de seguridad RLS.', 3),
    ('bootcamp-n8n', '04', 'Orquestacion de Agentes Autonomos LLM en n8n', 'Configuracion de AI Agent con Claude 3.5 Sonnet, Custom Tools (Tool Calling) y RAG con pgvector.', 4),
    ('bootcamp-n8n', '05', 'Telemetria, Sub-Flujos de Error & Alertas 24/7 en Telegram', 'Manejo de errores por sub-flujos, telemetria de ejecucion, monitoreo de VPS y Queue Mode con Redis.', 5),
    ('bootcamp-n8n', '06', 'Proyecto Final, Auditoria de Infraestructura y Certificacion', 'Defensa tecnica de un pipeline completo en produccion, backups a S3/R2 y emision de diploma.', 6),
